...
let anotherVariable = "Concatenation";
let concatenatedResult = myVariable + " " + anotherVariable;

// 5.) Use any of the variables above or create new ones and print using string interpolation

console.log(`Result: ${concatenatedResult}`);
...
const lastName = "Stonebanks";
const fullName = firstName.concat(" ", lastName);
console.log(fullName)

// Create a string and make it return true using startsWith()
const startsWithExample = "Hello World";
console.log(startsWithExample.startsWith("Hello"));
...
console.log(`Last Index of 'Vanessa': ${lastIndexOfVanessa}`);


// Can we use length for strings? I don't know, you tell me.
const noWeCantTeo = "but did you try it out though?"
console.log(`Length of noWeCantTeo: ${noWeCantTeo.length}`);
...
const joshIsLookingForWifeyIndex = joshIsLookingForWifey.search(/wifey/i);
console.log(`Index of 'wifey': ${joshIsLookingForWifeyIndex}`);

// I guess we can share this pizza sentence. Use slice() to return the other half of pizza.
const pizzaSentence = "pizza, other half of pizza"
const otherHalfOfPizza = pizzaSentence.slice(13);
console.log(`Other Half of Pizza: ${otherHalfOfPizza}`);

// Now using the pizza sentence, return only pizza (before the comma)
const onlyPizza = pizzaSentence.slice(0, pizzaSentence.indexOf(","));
console.log(`Only Pizza: ${onlyPizza}`);
...
const splitTheBillArray = splitTheBill.split(", ");
console.log(`Split the Bill: ${splitTheBillArray}`);
...
const splitTheBillCharactersArray = splitTheBill.split("");
console.log(`Split the Bill into Characters: ${splitTheBillCharactersArray}`);

// Use this toLowerCase()
const angry = "LOWER YOUR VOICE DOWN IF YOU AIN'T PAYING MY BILLS."
const lowercasedAngry = angry.toLowerCase();
console.log(`Lowercased Angry: ${lowercasedAngry}`);

// Tuan was angry today. Create a string with words that Tuan would yell out. Now lowercase it, to tell Tuan to chill out. 
const tuansAngryWords = "I DON'T LIKE THIS!";
const chillOutTuan = tuansAngryWords.toLowerCase();
console.log(`Chill out, Tuan: ${chillOutTuan}`);


// toUpperCase()
const jahlunSaidToPutSomeRespectToHisName = "jahlun"
const uppercasedJahlun = jahlunSaidToPutSomeRespectToHisName.toUpperCase();
console.log(`Uppercased Jahlun: ${uppercasedJahlun}`);
...
const substringExample1 = basicGreeting.substring(1, 4);
console.log(`Substring Example 1: ${substringExample1}`);

// Returns "JavaScript"
const ohReally = "JavaScript Substring"
const substringExample2 = ohReally.substring(0, 10);
console.log(`Substring Example 2: ${substringExample2}`);

// Returns aol.com
const aslDays = "xXteoWuzHereXx@aol.com"
const substringExample3 = aslDays.substring(aslDays.indexOf("@") + 1);
console.log(`Substring Example 3: ${substringExample3}`);

// trim()
// If only I can use this for my love handles...
// Create a variable with a string value with some extra loving on both sides.
const loveHandlesString = "    Extra Love Handles    ";
const trimmedLoveHandles = loveHandlesString.trim();
console.log(`Trimmed Love Handles: ${trimmedLoveHandles}`);
...
const exoticFruits = ["acai", "passion fruit", "papaya"];
...
console.log(`Last Two Exotic Fruits: ${combinedFruits.slice(-2)}`);
...
const RafaelNoBadWordsFiltered = RafaelNoBadWords.split(" ").filter(word => word.toLowerCase() !== badWord).join(" ");
console.log(`Rafael's Clean Sentence: ${RafaelNoBadWordsFiltered}`);
...
const totalNumbers = numbersToAddUp.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
console.log(`Total of Numbers to Add Up: ${totalNumbers}`);
...
function add(a, b, c) {
  const result = a + b + c;
  console.log(`Result of adding ${a}, ${b}, and ${c} is: ${result}`);
}
add(1, 2, 3);
...
propertiesArray.forEach(property => console.log(property));
